...
export const Footer = () => {
  return (
    <footer className="w-full bg-teal-950 text-white pt-16 pb-10 mt-48 max-md:mt-10">
      {/* Outer full-width background */}
      <div className="w-full flex justify-center">
        {/* Inner content limited to 1920px */}
        <div className="w-full max-w-[1920px] mx-auto flex flex-wrap justify-between items-start gap-y-12 gap-x-10 px-[10%] max-md:px-5">
